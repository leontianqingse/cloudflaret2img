...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/t2img
```

A live public deployment of this template is available at [https://t2img.templates.workers.dev](https://t2img.templates.workers.dev)
